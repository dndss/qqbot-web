...
class Bot extends client_1.Client {
    constructor(config) {
        ...
        this.groupService = new services_1.GroupService(this.request);
        // 获取基础URL
     ...
     * @param group_id 群 OpenID
     */
    async getGroupBotState(group_id) {
     ...
     * @param group_id 群 OpenID
     */
    async getGroupRestrictChatSetting(group_id) {
     ...
     */
    async setGroupMemberMuteState(group_id, members) {
